...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FDCApi()
        api_instance.get_food  # this is an instance of the class Endpoint
        api_instance.get_food()  # this invokes api_instance.get_food.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_food.callable or self.callable in this class
